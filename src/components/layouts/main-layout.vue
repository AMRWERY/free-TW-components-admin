                    ...
                    <div class="flex-1">
                        <nav>
                            <ul class="list-none p-0 pb-12 m-0 space-y-1">
                                ...
                                <li class="relative flex justify-between items-center px-3 py-3 rounded-lg cursor-pointer transition-all duration-300 text-sm font-medium group"
                                    :class="$route.path === '/categories' ? 'bg-cyan-500/10 text-cyan-400 border border-cyan-500/30' : 'text-gray-400 hover:text-white hover:bg-gray-800/50'">
                                    <router-link to="/categories" class="flex items-center justify-between w-full"
                                        @click="sidebarOpen = false">
                                        <div v-if="$route.path === '/categories'"
                                            class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-gradient-to-b from-cyan-400 to-blue-500 rounded-r-full">
                                        </div>
                                        <span class="flex-grow pl-2">Categories</span>
                                    </router-link>
                                </li>
                            </ul>
                        </nav>
