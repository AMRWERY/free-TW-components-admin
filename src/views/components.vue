  ...
  <div>
    <div class="py-8 min-h-screen">
      ...
      <div class="overflow-x-auto">
        <table
          class="min-w-full bg-white border border-gray-100 hover:border-gray-300"
        >
          <thead class="bg-gray-100 whitespace-nowrap">
            <tr>
              <th
                class="p-4 text-left text-[13px] font-semibold text-slate-900"
              >
                #
              </th>
              <th
      ...
      <delete-dialog
        ...
        :component-name="deleteComponentName"
