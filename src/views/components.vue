      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white border border-gray-100 hover:border-gray-300">
          ...
          <tbody class="whitespace-nowrap">
            ...
            <!-- Actual Data -->
            <template v-else>
              <tr class="hover:bg-gray-50 cursor-pointer border-b" v-for="(component, index) in paginatedComponents"
                :key="component.id">
                ...
                <td class="p-4 text-[15px] text-slate-600 font-medium">
                  <span class="px-2 py-1 text-green-600 bg-blue-100 hover:bg-blue-400 hover:text-gray-100 rounded-full">
                ...
                <td class="p-4">
                  <div class="flex items-center justify-end gap-4">
                    ...
                    <button class="mr-3 cursor-pointer" title="Edit" v-if="editingComponentId !== component.id"
                    ...
                    <button title="Delete" class="cursor-pointer" @click="openDeleteDialog(component.id)">
  ...
  ():
    ...
    if (editingComponentId.value !== null) {
      const component = components.value.find(
        (c) => c.id === editingComponentId.value
      );
      if (component) {
        return {
          name: component.name,
